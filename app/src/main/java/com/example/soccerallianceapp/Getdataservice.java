...
//    Call<Weather> getWeather(@Path("geoId")int geoId);
    ...
    @GET("AddMatchScore&{match_id}&{team_id1}&{goal1}&{shots1}&{shots_on_target1}&{possession1}&{passes1}&{pass_accuracy1}&{fouls1}&{yellow_cards1}&{red_cards1}&{offsides1}&{corners1}&{team_id2}&{goal2}&{shots2}&{shots_on_target2}&{possession2}&{passes2}&{pass_accuracy2}&{fouls2}&{yellow_cards2}&{red_cards2}&{offsides2}&{corners2}")
    Call<ResponseBody> addmatchscore(@Path("match_id") int Match_Id, @Path("team_id1") int Team_Id1,
                                        @Path("goal1") int Goal1, @Path("shots1") int Shots1,
                                        @Path("shots_on_target1") int Shots_On_Target1, @Path("possession1") int Possession1,
                                        @Path("passes1") int Passes1, @Path("pass_accuracy1") int Pass_Accuracy1,
                                        @Path("fouls1") int Fouls1, @Path("yellow_cards1") int Yellow_Cards1,
